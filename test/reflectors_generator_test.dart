...
void main() {
  group('Reflection test', () {
    ...
    test('Generate file reflect', () {
      ReflectorGenerator(directories: ['${DirectoryUtilities.prefixRouteLocal}/lib'], fileCreationPlace: '${DirectoryUtilities.prefixRouteLocal}/lib/src/reflection', albumName: 'MaxiLibraryDb').build();
    });
/*
